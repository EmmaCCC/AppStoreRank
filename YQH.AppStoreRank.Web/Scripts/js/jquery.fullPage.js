	...
	$.fn.fullpage = function(options) {
		...
		*/
		...
		$.fn.fullpage.reBuild = function(resizing){
			...
			$('.fp-section').each(function(){
				...
				var scrollWidth = windowsWidth - parseInt($(this).css('padding-bottom')) - parseInt($(this).css('padding-top'));
		...
		*/
		function setBodyClass(text){
			...
			$("section#showmod")[0].className = $("section#showmod")[0].className.replace(/\b\s?fp-viewing-[^\s]+\b/g, '');

			//adding the current anchor
			$("section#showmod").addClass("fp-viewing-" + text);
		}
