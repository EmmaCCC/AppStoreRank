...
public class Crawler
{
    ...
    public Crawler Fetch()
    {
        ...
        using (var response = request.GetResponse() as HttpWebResponse)
        {
            ...
            ServerUrl = PathFormatter.Format(Path.GetFileName(this.SourceUrl.Replace("?x-oss-process=style/xm", "")), Config.GetString("catcherPathFormat"));
            //var savePath = Server.MapPath(ServerUrl);
            var savePath = ConfigurationManager.AppSettings["UploadPath"] + ServerUrl;//修改成绝对路径 
